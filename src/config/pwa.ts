...
export const PWA_CONFIG = {
  ...
  STATIC_FILES: [
    ...
    '/src/js/core/firebase-init.js',
    '/src/js/core/core.js',
    '/src/js/core/header-interactions.js',
    '/src/js/modules/auth.js',
    '/src/js/modules/auth-enhanced.js',
    '/src/js/modules/ui-interactions.js',
    '/src/js/pages/homepage.js',
    '/src/js/pages/diary-wellness.js',
    '/src/js/pages/evaluacion.js',
    '/src/js/pages/planes.js',
    '/src/js/pages/equipo.js',
    '/src/js/pages/contacto.js',
    '/src/js/pages/ansiedad.js',
    '/src/js/pages/test.js',
    '/src/js/pages/politica-privacidad.js',
    '/src/js/pages/terminos-uso.js',
  ],
