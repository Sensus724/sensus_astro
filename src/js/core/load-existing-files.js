...
const organizedFiles = {
    ...
    // === COMPONENTES ===
    components: [
        '/src/js/core/header-interactions.js'
    ],
    
    // === MÓDULOS ===
    modules: [
        '/src/js/modules/auth-enhanced.js',
        '/src/js/modules/firebase-config.js'
    ],
    
    // === PÁGINAS ESPECÍFICAS ===
    pages: [
        '/src/js/pages/homepage.js',           // Página de inicio
        '/src/js/pages/diary-wellness.js',     // Diario de bienestar
        '/src/js/pages/evaluacion.js',         // Evaluación de ansiedad
        '/src/js/pages/planes.js',             // Página de planes
        '/src/js/pages/contacto.js',           // Página de contacto
        '/src/js/pages/equipo.js',             // Página de equipo
        '/src/js/pages/test.js',               // Página de tests
        '/src/js/pages/ansiedad.js',           // Página de ansiedad
        '/src/js/pages/secondary-pages.js'     // Páginas secundarias (política, términos, etc.)
    ]
};
...
function loadPageSpecificFiles(pageName) {
    const pageFiles = {
        ...
        'diario': ['/src/js/pages/diary-wellness.js'],
        'evaluacion': ['/src/js/pages/evaluacion.js'],
        'planes': ['/src/js/pages/planes.js'],
        'contacto': ['/src/js/pages/contacto.js'],
        'equipo': ['/src/js/pages/equipo.js'],
        'test': ['/src/js/pages/test.js'],
        'ansiedad': ['/src/js/pages/ansiedad.js'],
        'politica-privacidad': ['/src/js/pages/secondary-pages.js'],
        'terminos-uso': ['/src/js/pages/secondary-pages.js']
    };
...
function reloadPageFiles(pageName) {
    ...
    const existingScripts = document.querySelectorAll('script[src*="/src/js/pages/"]');
